...
#   timestamp: 2025-09-26T06:49:17+00:00
...
class BotSharingStatusResponse(BaseModel):
    """
    ...
    group_ids: Optional[list[str]] = Field(
        None, description='List of department IDs where the bot is published'
    )
    is_global: Optional[bool] = Field(
        None, description='Whether the bot is published globally'
    )
...
class CollectionSharingStatusResponse(BaseModel):
    """
    ...
    is_published: bool = Field(..., description='Whether published to marketplace')
    group_ids: Optional[list[str]] = Field(
        None, description='List of department IDs where the collection is published'
    )
    is_global: Optional[bool] = Field(
        None, description='Whether the collection is published globally'
    )
...
class User(BaseModel):
    ...
    department_id: Optional[str] = Field(
        None, description='The department ID the user belongs to'
    )
...
class Department(BaseModel):
    id: Optional[str] = Field(None, description='The ID of the department')
    parent_id: Optional[str] = Field(
        None, description='The parent department ID, -1 for root department'
    )
    name: Optional[str] = Field(None, description='The name of the department')
    status: Optional[Literal[0, 1]] = Field(
        None, description='The status of the department (0=inactive, 1=active)'
    )
    group_path: Optional[str] = Field(
        None, description='The hierarchical path of the department'
    )
    tenant_id: Optional[str] = Field(
        None, description='The tenant ID this department belongs to'
    )
    tenant_name: Optional[str] = Field(
        None, description='The tenant name this department belongs to'
    )
    created_at: Optional[str] = Field(
        None, description='The date and time the department was created'
    )
    updated_at: Optional[str] = Field(
        None, description='The date and time the department was last updated'
    )
    children: Optional[list[Department]] = Field(
        None, description='Child departments (only present in hierarchical mode)'
    )
...
class DepartmentList(BaseModel):
    ...
    items: Optional[list[Department]] = None
    pageResult: Optional[PageResult] = None
